 ...
 */
@ThreadSafe
public abstract class ValidatorHandler<T> implements Validator<T>, Composable<T> {
    ...
    @Override
    public boolean validate(ValidatorContext context, ValidatorElement element, T t) {
        return true;
    }
    ...
    @Override
    public void compose(ValidUtils current, ValidatorContext context, T t) {
